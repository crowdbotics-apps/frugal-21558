"""frugal_21558 URL Configuration
...
admin.site.site_header = "frugal"
admin.site.site_title = "frugal Admin Portal"
admin.site.index_title = "frugal Admin"

# swagger
api_info = openapi.Info(
    title="frugal API",
    default_version="v1",
    description="API documentation for frugal App",
)
